...
export interface PaletteColor {
  key: string
  /** Only ever rendered in the Payload admin (select options + swatch picker). */
  label: string
  light: string
  dark: string
...
export const palette: PaletteColor[] = [
  ...
  { key: 'coral', label: 'Corail', light: '#c2410c', dark: '#ff8566', fgOnLight: 'light', fgOnDark: 'dark' },
  { key: 'red', label: 'Rouge', light: '#b91c1c', dark: '#f87171', fgOnLight: 'light', fgOnDark: 'dark' },
  { key: 'crimson', label: 'Cramoisi', light: '#9f1239', dark: '#fb7185', fgOnLight: 'light', fgOnDark: 'dark' },
  { key: 'rose', label: 'Rose', light: '#be123c', dark: '#fb7185', fgOnLight: 'light', fgOnDark: 'dark' },
  { key: 'pink', label: 'Rose vif', light: '#be185d', dark: '#f472b6', fgOnLight: 'light', fgOnDark: 'dark' },
  { key: 'purple', label: 'Pourpre', light: '#7e22ce', dark: '#c084fc', fgOnLight: 'light', fgOnDark: 'dark' },
  ...
  { key: 'blue', label: 'Bleu', light: '#1d4ed8', dark: '#60a5fa', fgOnLight: 'light', fgOnDark: 'dark' },
  { key: 'sky', label: 'Ciel', light: '#0369a1', dark: '#38bdf8', fgOnLight: 'light', fgOnDark: 'dark' },
  { key: 'cyan', label: 'Cyan', light: '#0e7490', dark: '#22d3ee', fgOnLight: 'light', fgOnDark: 'dark' },
  { key: 'teal', label: 'Sarcelle', light: '#0f766e', dark: '#2dd4bf', fgOnLight: 'light', fgOnDark: 'dark' },
  { key: 'mint', label: 'Menthe', light: '#0c815e', dark: '#6ee7b7', fgOnLight: 'light', fgOnDark: 'dark' },
  { key: 'emerald', label: 'Émeraude', light: '#047857', dark: '#34d399', fgOnLight: 'light', fgOnDark: 'dark' },
  { key: 'green', label: 'Vert', light: '#15803d', dark: '#4ade80', fgOnLight: 'light', fgOnDark: 'dark' },
  { key: 'lime', label: 'Citron vert', light: '#4d7c0f', dark: '#a3e635', fgOnLight: 'light', fgOnDark: 'dark' },
  { key: 'olive', label: 'Olive', light: '#5f6b1f', dark: '#c3d16a', fgOnLight: 'light', fgOnDark: 'dark' },
  { key: 'gold', label: 'Or', light: '#92660a', dark: '#e8b93f', fgOnLight: 'light', fgOnDark: 'dark' },
  { key: 'amber', label: 'Ambre', light: '#b45309', dark: '#fbbf24', fgOnLight: 'light', fgOnDark: 'dark' },
  { key: 'yellow', label: 'Jaune', light: '#a16207', dark: '#facc15', fgOnLight: 'light', fgOnDark: 'dark' },
  { key: 'slate', label: 'Ardoise', light: '#475569', dark: '#a3b1c6', fgOnLight: 'light', fgOnDark: 'dark' },
  { key: 'gray', label: 'Gris', light: '#4b5563', dark: '#a8afb8', fgOnLight: 'light', fgOnDark: 'dark' },
  { key: 'neutral', label: 'Neutre', light: '#525252', dark: '#a8a8a8', fgOnLight: 'light', fgOnDark: 'dark' },
]
