...
export function TestimonialCard({ testimonial }: TestimonialCardProps) {
  ...
  return (
    <article
      className="card-glow flex h-full flex-col justify-between rounded-[28px] border border-border bg-bg-elevated p-7 shadow-lg shadow-black/5 transition duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:-translate-y-1.5 hover:border-accent-soft-border"
      data-cursor="pointer"
    >
