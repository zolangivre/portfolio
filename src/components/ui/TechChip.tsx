...
const CHIP_CLASSNAME =
  'flex items-center gap-1.5 rounded-full border border-border bg-surface px-3 py-1 text-[11px] font-medium uppercase tracking-[0.2em] text-fg-muted transition hover:border-accent-soft-border hover:text-fg'
